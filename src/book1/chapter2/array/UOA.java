...
public class UOA<T> {
	...
	public KeyMode fetch(Object targetKey) { // access the node using a
											 // sequential search, returns null
											 // for
		                                     // not found
	...
	public boolean delete(Object targetKey) { // access the node using a
											  // sequential search, returns null
											  // for
		                                      // not found
		KeyMode node = (KeyMode) data[0];
