...
public class BinaryTrie<Node extends BinaryTrie.Naide<Node,T>, T> implements SSet<T> {
	
	public static class Naide<Node extends Naide<Node, T>, T>  {
		T x;
		Node parent;
		Node[] child;
		Node jump;
	...
	public static <N extends BinaryTrie.Naide<N,Integer> > 
