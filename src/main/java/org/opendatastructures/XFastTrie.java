package org.opendatastructures;

public class XFastTrie<Node extends XFastTrie.Naide<Node,T>, T> 
	...
	protected static class Naide<N extends Naide<N, T>, T> 
		extends	BinaryTrie.Naide<N, T> {
		int prefix;
		@SuppressWarnings("unchecked")
		public boolean equals(Object u) {
			return (u instanceof Naide<?, ?>)
					&& this.prefix == ((Naide<N,T>)u).prefix;
		}
		public int hashCode() {
			return prefix;
		}
	...
	public XFastTrie(Node sampleNode, Integerizer<T> it)  {
		...
		Node nil = (Node)new XFastTrie.Naide<Node,T>();
	...
	public XFastTrie(Integerizer<T> it)  {
		this((Node)new XFastTrie.Naide<Node,T>(), it);
	}
	...
	public static void main(String[] args) {
		class N extends XFastTrie.Naide<N, Integer> {};
