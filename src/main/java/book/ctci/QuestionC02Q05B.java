...
public class QuestionC02Q05B {
	...
	private static QuestionC02Q05PartialSum addListsHelper(LinkedListNode l1, LinkedListNode l2) {
		if (l1 == null && l2 == null) {
			QuestionC02Q05PartialSum sum = new QuestionC02Q05PartialSum();
			return sum;
		}
		QuestionC02Q05PartialSum sum = addListsHelper(l1.next, l2.next);
	...
	private static LinkedListNode addLists(LinkedListNode l1, LinkedListNode l2) {
		...
		QuestionC02Q05PartialSum sum = addListsHelper(l1, l2);
		if (sum.carry == 0) {
			return sum.sum;
		} else {
