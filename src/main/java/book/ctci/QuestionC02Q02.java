...
import book.ctci.library.AssortedMethods;
import book.ctci.library.LinkedListNode;

public class QuestionC02Q02 {
	...
	public static LinkedListNode nthToLastR2(LinkedListNode head, int n, QuestionC02Q02IntWrapper i) {
		if (head == null) {
			return null;
		}
	...
	public static QuestionC02Q02Result nthToLastR3Helper(LinkedListNode head, int k) {
		if (head == null) {
			return new QuestionC02Q02Result(null, 0);
		}
		QuestionC02Q02Result res = nthToLastR3Helper(head.next, k);
		if (res.node == null) {
			res.count++;
			if (res.count == k) {
				res.node = head;
	...
	public static LinkedListNode nthToLastR3(LinkedListNode head, int k) {
		QuestionC02Q02Result res = nthToLastR3Helper(head, k);
		if (res != null) {
			return res.node;
		}
		return null;
	...
	public static void main(String[] args) {
		...
		int nth = 3;
		QuestionC02Q02IntWrapper wr = new QuestionC02Q02IntWrapper();
